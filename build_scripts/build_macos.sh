...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Weed-darwin-x64/Weed.app --platform=darwin \
...
mv Weed-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Weed-$WEED_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Weed-darwin-x64/Weed.app Weed-$WEED_INSTALLER_VERSION \
