...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Peas-darwin-arm64/Peas.app --platform=darwin \
...
mv Peas-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Peas-$PEAS_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Peas-darwin-arm64/Peas.app Peas-$PEAS_INSTALLER_VERSION-arm64 \
