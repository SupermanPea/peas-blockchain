...
required to run a [Timelord](https://github.com/Peas-Network/peas-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Peas-Network/peas-blockchain/blob/main/install-timelord.sh)
