...
required to run a [Timelord](https://github.com/Weed-Network/weed-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Weed-Network/weed-blockchain/blob/main/install-timelord.sh)
