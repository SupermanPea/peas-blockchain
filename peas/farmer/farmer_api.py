...
from peas.consensus.network_type import NetworkType
from peas.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from peas.farmer.farmer import Farmer
from peas.protocols import farmer_protocol, harvester_protocol
from peas.protocols.harvester_protocol import PoolDifficulty
...
from peas.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSPeasConnection
    ):
        """
