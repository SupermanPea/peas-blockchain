...
import stat
import sys
from peas.util.config import load_config, traverse_dict
from peas.util.permissions import octal_mode_string, verify_file_permissions
...
def check_ssl(root_path: Path) -> None:
    ...
    if not valid:
        ...
        print("Run `peas init --fix-ssl-permissions` to fix issues.")
