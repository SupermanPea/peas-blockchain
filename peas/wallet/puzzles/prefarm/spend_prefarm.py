...
from peas.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "pea16ljz9fll4lj2p402ytsfy24sfy7lplmc90vdfsqcppjfyj95ehsssqey9j"  # Key 1
        address2 = "pea16ljz9fll4lj2p402ytsfy24sfy7lplmc90vdfsqcppjfyj95ehsssqey9j"  # Key 2
        ...
        print(f"Ph1: {ph1.hex()}")
        print(f"Ph2: {ph2.hex()}")
        assert ph1.hex() == "0xd7e422a7ffafe4a0d5ea22e0922ab0493df0ff782bd8d4c01808649248b4cde1"
        assert ph2.hex() == "0xd7e422a7ffafe4a0d5ea22e0922ab0493df0ff782bd8d4c01808649248b4cde1"
