...
from peas.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "peas" in cc_discrepancies:
                    cc_discrepancies["peas"] = cc_discrepancies["peas"] + diff
                else:
                    cc_discrepancies["peas"] = diff
