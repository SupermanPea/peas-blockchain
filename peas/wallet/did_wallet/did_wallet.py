...
from peas.protocols.wallet_protocol import RespondAdditions, RejectAdditionsRequest
...
from peas.util.ints import uint64, uint32, uint8
from peas.wallet.util.transaction_type import TransactionType

from peas.wallet.did_wallet.did_info import DIDInfo
...
from peas.wallet.did_wallet import did_wallet_puzzles
