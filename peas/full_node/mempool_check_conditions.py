...
from peas.full_node.generator import create_generator_args, setup_generator_args
from peas.types.blockchain_format.coin import Coin
from peas.types.blockchain_format.program import NIL
...
from peas.util.ints import uint32, uint64, uint16
from peas.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see peas/types/blockchain_format/program.py)
