...
from peas.harvester.harvester import Harvester
from peas.plotting.util import PlotInfo, parse_plot_info
from peas.protocols import harvester_protocol
from peas.protocols.farmer_protocol import FarmingInfo
from peas.protocols.harvester_protocol import Plot
...
from peas.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSPeasConnection
    ):
        """
