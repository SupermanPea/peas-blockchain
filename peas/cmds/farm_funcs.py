...
from peas.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total peas farmed: {amounts['farmed_amount'] / units['peas']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['peas']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['peas']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'peas start wallet' and 'peas wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'peas wallet show'")
    else:
        print("Note: log into your key using 'peas wallet show' to see rewards for each key")
