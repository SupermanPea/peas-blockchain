  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Peas Blockchain Wiki' }),
            click: () => {
              openExternal(
                'https://github.com/Peas-Network/peas-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Peas-Network/peas-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Peas-Network/peas-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Peas-Network/peas-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Peas-Network/peas-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/peas_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/peas_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Peas Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Peas' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Peas Blockchain' }),
            click: () => {
              openAbout();
            },
          },
