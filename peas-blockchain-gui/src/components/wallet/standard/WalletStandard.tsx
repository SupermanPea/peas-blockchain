...
import { /* mojo_to_peas_string, */ peas_to_mojo } from '../../../util/peas';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_peas_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of peas in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Peas that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Peas that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send peas to coloured address. Please enter a peas
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'peas_addr://') {
    ...
    const amountValue = Number.parseFloat(peas_to_mojo(amount));
    const feeValue = Number.parseFloat(peas_to_mojo(fee));
