...
import { CardHero, Flex, Link } from '@peas/core';
import { PlotHero as PlotHeroIcon } from '@peas/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Peas. '
              }
              <Link
                target="_blank"
                href="https://github.com/Peas-Network/peas-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
