...
import icon from '../../assets/img/peas_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Peas Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Peas-Network/peas-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
