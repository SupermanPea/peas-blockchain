...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of peas', () => {
      const result = units.getUnit('peas');
    ...
    it('gets unit of peas using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of peas', () => {
      const result = units.getDisplay('peas');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('peas', 9);

      const result = units.getUnit('peas');

      expect(result).toEqual(9);

      units.setUnit('peas', 1);
    });
  });
  describe('#setDisplay', () => {
