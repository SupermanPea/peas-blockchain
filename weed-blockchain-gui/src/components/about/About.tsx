...
import icon from '../../assets/img/weed_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Weed Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Weed-Network/weed-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
