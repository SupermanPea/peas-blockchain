...
import { CardHero, Flex, Link } from '@weed/core';
import { PlotHero as PlotHeroIcon } from '@weed/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Weed. '
              }
              <Link
                target="_blank"
                href="https://github.com/Weed-Network/weed-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
