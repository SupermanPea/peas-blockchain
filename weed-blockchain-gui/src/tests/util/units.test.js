...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of weed', () => {
      const result = units.getUnit('weed');
    ...
    it('gets unit of weed using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of weed', () => {
      const result = units.getDisplay('weed');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('weed', 9);

      const result = units.getUnit('weed');

      expect(result).toEqual(9);

      units.setUnit('weed', 1);
    });
  });
  describe('#setDisplay', () => {
