  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Weed Blockchain Wiki' }),
            click: () => {
              openExternal(
                'https://github.com/Weed-Network/weed-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Weed-Network/weed-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Weed-Network/weed-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Weed-Network/weed-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Weed-Network/weed-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/weed_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/weed_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Weed Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Weed' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Weed Blockchain' }),
            click: () => {
              openAbout();
            },
          },
