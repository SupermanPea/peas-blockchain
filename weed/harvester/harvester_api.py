...
from weed.harvester.harvester import Harvester
from weed.plotting.util import PlotInfo, parse_plot_info
from weed.protocols import harvester_protocol
from weed.protocols.farmer_protocol import FarmingInfo
from weed.protocols.harvester_protocol import Plot
...
from weed.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSWeedConnection
    ):
        """
