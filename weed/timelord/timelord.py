...
from weed.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from weed.timelord.iters_from_block import iters_from_block
from weed.timelord.timelord_state import LastState
from weed.timelord.types import Chain, IterationType, StateType
from weed.types.blockchain_format.classgroup import ClassgroupElement
from weed.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[WeedServer] = None
