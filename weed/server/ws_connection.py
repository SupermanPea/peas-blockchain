...
from weed.cmds.init_funcs import weed_full_version_str
from weed.protocols.protocol_message_types import ProtocolMessageTypes
from weed.protocols.shared_protocol import Capability, Handshake
...
from weed.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from weed.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSWeedConnection:
    """
