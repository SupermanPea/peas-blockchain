...
from weed.consensus.network_type import NetworkType
from weed.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from weed.farmer.farmer import Farmer
from weed.protocols import farmer_protocol, harvester_protocol
from weed.protocols.harvester_protocol import PoolDifficulty
...
from weed.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSWeedConnection
    ):
        """
