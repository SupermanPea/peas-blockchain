...
from weed.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "weed" in cc_discrepancies:
                    cc_discrepancies["weed"] = cc_discrepancies["weed"] + diff
                else:
                    cc_discrepancies["weed"] = diff
