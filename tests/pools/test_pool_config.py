...
from peas.pools.pool_config import PoolWalletConfig
from peas.util.config import load_config, save_config, create_default_peas_config
...
def test_pool_config():
    ...
    create_default_peas_config(test_root, ["config.yaml"])
