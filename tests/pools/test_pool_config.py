...
from weed.pools.pool_config import PoolWalletConfig
from weed.util.config import load_config, save_config, create_default_weed_config
...
def test_pool_config():
    ...
    create_default_weed_config(test_root, ["config.yaml"])
